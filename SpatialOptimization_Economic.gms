...
iMaxAmmoniaStable(sStable) = sum(sAnimalCategory, smax(sStableType, (pEmissionFactor(sAnimalCategory, sStableType)) *
                                 pAnimals(sStable, sAnimalCategory)))      ;
...
vEmissionAll.fx(sStable, sStableType)$(not sPossibleStables(sStable, sStableType)) = 0 ;
vAmmoniaEmissionStableType.fx(sStable, sStabletype)$(not sPossibleStables(sStable, sStableType)) = 0 ;
;
...
*- pEmissionAll(sStable, sStableType) + sum(sAnimalCategory, (vAnimals(sStable, sAnimalCategory) * pEmissionFactor(sAnimalCategory, sStableType))) ;
...
eqAmmoniaStableStableType2(sStable, sStableType)..
vAmmoniaEmissionStableType(sStable, sStabletype) =l= vStable(sStable, sStableType) * 100000000      ;
$offtext

*Derde Poging   https://www.leandro-coelho.com/linearization-product-variables/
Equation
...
eqEmissionAll(sPossibleStables(sStable, sStableType))..
...
eqAmmoniaStableStableType1(sPossibleStables(sStable, sStableType))..
vAmmoniaEmissionStableType(sStable, sStabletype) =l= iMaxAmmoniaStable(sStable)  * vStable(sStable, sStableType) ;
...
eqAmmoniaStableStableType3(sPossibleStables(sStable, sStableType))..
vAmmoniaEmissionStableType(sStable, sStabletype) =g= vEmissionAll(sStable, sStableType) - (1- vStable(sStable, sStableType)) * iMaxAmmoniaStable(sStable)  ;
